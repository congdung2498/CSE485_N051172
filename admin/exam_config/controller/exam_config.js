...
app.controller("examCtl", function($scope,$http,$timeout) {
    ...
    $scope.getExams=function(){
        $http.get("http://localhost/test-app/admin/exam_config/controller/getExam.php?method=load_Exams").then(function (response) {
    ...
    $scope.saveExam=function(){
        var request = $http({
            method: "POST",
            url: "http://localhost/test-app/admin/exam_config/controller/postExam.php?method=post_question",
            data: {
                exam: $scope.exam
            },
    ...
    $scope.deleteExam= function(){
        var request = $http({
            method: "POST",
            url: "http://localhost/test-app/admin/exam_config/controller/deleteExam_config.php?method=del_exam",
            data: {
    ...
    $scope.getUserbyExID =function(){
        ...
        var request = $http({
            method: "POST",
            url: "http://localhost/test-app/admin/exam_config/controller/getUserbyExamID.php?method=load_users",
            data: {
                examID: $scope.exam.ID_ExamConfig
            },
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
